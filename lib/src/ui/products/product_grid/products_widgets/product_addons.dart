...
//
//   const ProductAddons({Key? key, required this.product, required this.addOnsFormData, this.addonFormKey}) : super(key: key);
//
//   @override
...
//         }
//
//         if(model.productAddons[i].fields[f].type == 'checkbox' && model.productAddons[i].fields[f].display == 'radiobutton') {
//           list.add(
//               ListTile(
//                 title: Text(model.productAddons[i].fields[f].name, style: headingStyle),
//                 subtitle: Text(model.productAddons[i].fields[f].description),
...
//
//       print(addonFields[f].type);
//       print(addonFields[f].display);
//
//
...
//                 subtitle: addonFields[f].description.isNotEmpty ? Text(addonFields[f].description) : null,
//               )
//           );
...
//       }
//
//       if(addonFields[f].type == 'checkbox' && addonFields[f].display == 'radiobutton') {
//
//         list.add(
//             ListTile(
//               title: Text(addonFields[f].name, style: headingStyle),
